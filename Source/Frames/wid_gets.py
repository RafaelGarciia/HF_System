...
class Basic_Entry():
    def __init__(self, parent, text) -> None:
        ...
        self.label = ttkb.Label(self._frame, text=text or 'Label:', width=10)
        self.label.grid(row=0, column=0, sticky='e')

        self.var = tk.StringVar(self._frame)

        self.entry = ttkb.Entry(self._frame, textvariable=self.var, width=40)
